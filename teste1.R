...
escrevendo pra ver se muda

teste <- function(cor2){
  ggplot(data = diamonds[diamonds$color == 'cor2',],
         aes(diamonds[diamonds$color == 'cor2',]$carat,
             diamonds[diamonds$color == 'cor2',]$price))+
    geom_point()+geom_smooth()}

teste(D)

dnovo <- ggplot(data = diamonds[diamonds$color == 'cor2',],
       aes(diamonds[diamonds$color == 'cor2',]$carat,
           diamonds[diamonds$color == 'cor2',]$price))
dnovo + geom_point+geom_smooth()+labs(y='price',x='cor D')
